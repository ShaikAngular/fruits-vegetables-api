...
public class VegetablesEntity {
	...
	protected VegetablesEntity(int vegetable_id, String vegetable_name, int vegetable_price, int vegetable_quantity,
			String vegetable_location) {
		super();
	...
	public String toString() {
		return "VegetablesEntity [vegetable_id=" + vegetable_id + ", vegetable_name=" + vegetable_name
